...
const ConsentForm = (props) => {
    return (
        <div style={consentStyle}>
            ...
            <p>The purpose of this study is to understand how people think about the different ways something could have happened.</p>
        ...
        We estimate that the study session will last about 8 minutes. You will be given full instructions shortly.</p>
